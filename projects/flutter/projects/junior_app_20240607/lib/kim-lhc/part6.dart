...
import 'package:junior_app_20240607/text/lhc_part6.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        RichText(
          text: TextSpan(
            children: <TextSpan>[
              TextSpan(text: 'Unfavorable working conditions:', style: TextStyle(fontSize: 20.0,fontWeight: FontWeight.bold, color: Colors.black)),
              TextSpan(text: ' $part6_score ', style: TextStyle(fontSize: 20.0, color: Colors.blueAccent, fontWeight: FontWeight.bold)),
              TextSpan(text: 'point', style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold, color: Colors.black)),
            ],
          ),
        ),
      ),
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        border: Border.all(color: Colors.black, width: 2.0), // 边框样式
                        borderRadius: BorderRadius.circular(20.0), // 圆角
                        color: Color(0xFFFFFCF2).withOpacity(1), // 背景色
                      ),
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
