  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: const Text(
          'Occasionally : "Loads difficult to grip / greater holding forces required / no shaped grips / work gloves"\nVery : "Loads hardly possible to grip / slippery, soft, sharp edges / no/unsuitable grips / work gloves"',
          style: TextStyle(
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: const Text(
          'Holds for 5~10 seconds : "The load has to be held between > 5 and 10 seconds or carried over a distance between > 2 m and 5 m"\nHold for > 10 seconds : " The load has to be held > 10 seconds or carried over a distance > 5 m."',
          style: TextStyle(
            color: Colors.blue, // 文字顏色
            fontSize: 24.0, // 文字大小
            fontWeight: FontWeight.bold, // 文字粗細
